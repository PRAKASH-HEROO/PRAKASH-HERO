...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/profile.php?id=61550020012580')
...
\033[1;32m【✪】Cʀᴇᴀᴛᴇᴅ Bʏ   ✯  👑 PRAKASH CHHINAL👑   
\033[1;32m【✪】FB Gʀᴏᴜᴘ     ✯  .....COMMING SOON
\033[1;32m【✪】Oɴ Gɪᴛʜᴜʙ    ✯  PRAKASH-HERO
\033[1;32m【✪】Tᴏᴏʟ SᴛᴀᴛᴜS  ✯  \033[1;32m𝕻𝖆𝖎𝕯  
\033[1;32m【✪】Tᴏᴏʟ Vᴇʀsɪᴏɴ ✯  1.0  
\033[1;37m-----PRAKASH KO CMD HO USE GAR-""")
def banner():
	print(logo)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[PRAKASH-XD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
